...
import { Calendar, ArrowRight, Search, Clock, TrendingUp, Sparkles, Rss, Tag, X } from "lucide-react";
...
export default function BlogClient() {
  ...
  const rssUrl = `${process.env.NEXT_PUBLIC_SUPABASE_URL || ""}/functions/v1/rss-feed`;
