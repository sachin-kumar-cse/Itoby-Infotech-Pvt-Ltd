...
export default function CareersClient() {
  ...
  return (
    <>
      ...
      <PageHeroBanner
        title="Build Your Career With Digital Innovators"
        description="Join an ambitious team of software engineers, UI/UX designers, and growth marketers creating world-class digital products."
        badge="Careers & Openings"
            ...
            >
              {jobs.map((job) => (
                <motion.div key={job.id} variants={fadeUp}>
                  <Link href={`/careers/${getJobSlug(job)}`}>
