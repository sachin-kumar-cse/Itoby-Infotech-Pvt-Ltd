    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <Button asChild><Link href="/careers">View All Jobs</Link></Button>
        </div>
      </div>
    );
  }
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="container-wide relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <Button variant="ghost" className="mb-6 -ml-2" onClick={() => router.push("/careers")}>
                  ...
                  <CardContent className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        By applying, you agree to our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>
                      </p>
                    </form>
                  </CardContent>
                </Card>
