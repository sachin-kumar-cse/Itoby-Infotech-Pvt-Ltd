...
const rotatingWords = ["High-Converting", "Stunning", "Powerful", "Scalable", "Innovative"];
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <motion.div style={{ y: backgroundY }} className="absolute inset-0">
        ...
        >
          <source
            src="https://cdn.pixabay.com/video/2020/05/25/39383-425289925_large.mp4"
            type="video/mp4"
          />
        </video>
      ...
      {[...Array(8)].map((_, i) => (
        <motion.div
          key={i}
          initial={{ opacity: 0 }}
          animate={{ opacity: [0, 0.5, 0], y: [0, -100], x: [0, Math.random() * 50 - 25] }}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="overflow-hidden">
              ...
              >
                <motion.span custom={0} variants={textRevealVariants} className="block">
                  We Build
                </motion.span>
                <motion.span custom={1} variants={textRevealVariants} className="block h-[1.2em]">
                  <RotatingText words={rotatingWords} interval={2500} />
                </motion.span>
                <motion.span custom={2} variants={textRevealVariants} className="block">
                  Digital Experiences
                </motion.span>
              </motion.h1>
            </div>
          ...
          >
            <MouseParallax intensity={15} className="w-full aspect-square max-w-lg mx-auto">
              <div className="relative w-full h-full">
                ...
                {/* Floating Icon Elements with 3D depth */}
                {floatingIcons.map(({ Icon, delay }, i) => (
                  <motion.div
                    ...
                    style={{ transformStyle: "preserve-3d", transform: `translateZ(${30 + i * 10}px)` }}
