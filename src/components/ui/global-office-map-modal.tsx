...
const officeHubs: OfficeHub[] = [
  {
    id: "noida",
    name: "Noida / Delhi-NCR HQ",
    country: "India",
    flag: "🇮🇳",
    type: "Global Headquarters & R&D Center",
    address: "Cyber Tower, Sector 62, Noida, Uttar Pradesh 201301",
    timezone: "Asia/Kolkata",
    phone: "+91 91225 82956",
    email: "hq@itobyinfotech.com",
    coords: { x: 70, y: 46 },
    status: "active",
  },
  {
    id: "patna",
    name: "Patna Operations Hub",
    country: "India",
    flag: "🇮🇳",
    type: "Software Development & Support",
    address: "IT Park, Fraser Road, Patna, Bihar 800001",
    timezone: "Asia/Kolkata",
    phone: "+91 91225 82956",
    email: "patna@itobyinfotech.com",
    coords: { x: 72, y: 48 },
    status: "active",
  },
  {
    ...
    flag: "🇺🇸",
    type: "North America Client & Sales Desk",
    address: "548 Market St, San Francisco, CA 94104",
    timezone: "America/Los_Angeles",
    phone: "+1 (415) 800-4921",
  ...
  },
  {
    ...
    flag: "🇬🇧",
    type: "Europe Tech & Consultancy Hub",
    address: "128 City Road, London EC1V 2NX",
    timezone: "Europe/London",
    phone: "+44 20 7946 0912",
    email: "uk@itobyinfotech.com",
    coords: { x: 48, y: 28 },
    status: "active",
  },
  {
    ...
    flag: "🇦🇪",
    type: "MENA Regional Business Center",
    address: "Dubai Internet City, Building 3, Dubai",
    timezone: "Asia/Dubai",
    phone: "+971 4 391 0000",
    email: "uae@itobyinfotech.com",
    coords: { x: 62, y: 44 },
    status: "active",
  },
];
