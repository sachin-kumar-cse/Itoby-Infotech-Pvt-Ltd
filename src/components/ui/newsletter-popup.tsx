      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-1/2 -translate-y-1/2 sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 z-[71] w-auto sm:w-[420px] max-w-[calc(100vw-32px)] rounded-3xl bg-card/90 backdrop-blur-xl border border-border/50 shadow-2xl overflow-hidden"
          >
            {/* Ambient glow */}
