...
const benefits = [
  {
    icon: Laptop,
    title: "Remote Work",
    description: "Flexible work-from-home options with hybrid arrangements available.",
  },
  {
    icon: GraduationCap,
    title: "Learning Budget",
    description: "₹50,000 annual budget for courses, certifications, and conferences.",
  },
  {
    icon: Heart,
  ...
  },
  {
    icon: Plane,
    title: "Paid Time Off",
    description: "25 days annual leave plus public holidays and sick leave.",
  },
  {
    icon: Gift,
  ...
  },
  {
    icon: Coffee,
    title: "Office Perks",
    description: "Free meals, snacks, gaming zone, and wellness programs.",
  },
];
...
const cultureValues = [
  ...
  },
  {
    icon: Rocket,
    title: "Growth",
    description: "We invest in our people's growth through mentorship and learning opportunities.",
  },
  {
    icon: Shield,
    title: "Integrity",
...
const hiringProcess = [
  ...
  },
  {
    ...
    description: "A 30-minute call with HR to discuss your background and expectations.",
  },
  {
    step: 3,
    title: "Technical Assessment",
    description: "Role-specific assessment or coding challenge to evaluate your skills.",
  },
  {
    step: 4,
    title: "Team Interview",
    description: "Meet the team you'll be working with and discuss the role in detail.",
  },
  {
    step: 5,
    title: "Final Interview",
    description: "Discussion with leadership about culture fit and career goals.",
  },
  {
    step: 6,
    title: "Offer",
    description: "Receive your offer letter and join the Itoby family!",
  },
];
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                At Itoby, we've built a culture where innovation thrives, collaboration is celebrated, 
                and every voice matters. Here's what drives us.
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className="container-wide">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Competitive compensation is just the beginning. We offer comprehensive benefits 
            ...
            <Card className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-card to-glow-secondary/10 border-primary/20">
              ...
              <CardContent className="relative z-10 p-8 sm:p-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button variant="hero-outline" size="xl" asChild>
                    <a href="mailto:careers@itobyinfotech.in">
                      Email Us Directly
                    </a>
                  </Button>
                </div>
