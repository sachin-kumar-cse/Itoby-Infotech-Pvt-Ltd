...
const Blog = () => {
  ...
  const projectId = process.env.NEXT_PUBLIC_SUPABASE_PROJECT_ID || (typeof import.meta !== "undefined" && import.meta.env?.VITE_SUPABASE_PROJECT_ID) || "uvpxfbucgcpsjwahmvjy";
  const rssUrl = `https://${projectId}.supabase.co/functions/v1/rss-feed`;
  ...
  return (
    <Layout>
      ...
      <PageHeroBanner
        title="Insights, Articles & Tech Trends"
        description="Stay updated with the latest trends, guides, and insights in web engineering, app development, digital marketing, and software design."
        badge="Knowledge & News"
        breadcrumbs={[{ label: "Blog" }]}
      />

            {/* Search + RSS */}
            <div className="section-padding pt-6 pb-10">
