...
const BookAppointment = () => {
  ...
  return (
    <Layout>
      ...
      <PageHeroBanner
        title="Schedule a Free Discovery Consultation Call"
        description="Pick a date & time that works best for you and our team of digital experts will be ready to discuss your project requirements."
        badge="1-on-1 Consultation"
        breadcrumbs={[{ label: "Book Call" }]}
      />

      <section className="section-padding min-h-screen pt-10">
                ...
                <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input type="email" placeholder="Email_Address" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-background" />
                    </div>
                    <div>
                      <label className="text-sm font-medium text-foreground mb-1.5 block">Phone</label>
                      <Input placeholder="+91 91427 73500" value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-background" />
                    </div>
                    <div>
